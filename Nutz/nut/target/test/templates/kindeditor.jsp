...
<head>
    ...
    <script charset="utf-8" src="<%=basePath%>/assets/js/kindeditor/kindeditor-all.js">
    </script>
    <script charset="utf-8" src="<%=basePath%>assets/js/kindeditor/lang/zh_CN.js">
    </script>
    <script charset="utf-8" src="<%=basePath%>/assets/js/kindeditor/plugins/code/prettify.js">
    </script>
    <script>
